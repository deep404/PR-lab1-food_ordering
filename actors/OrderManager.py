...
DINNING_HALL_HOST = 'dinning_hall'
...
class OrderManager:
    ...
    def make_order(self, order):
        ...
        for i, data in enumerate(orders):
            ...
            dh_url = f'http://{DINNING_HALL_HOST}:{rest["dinning_port"]}/v2/order'
    ...
    @staticmethod
    def rating(data):
        res = requests.post(f'http://{DINNING_HALL_HOST}:{data["dh_address"]}/rating', json=data)
        return res.json()